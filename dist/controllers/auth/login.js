...
const login_2 = __importDefault(require("../../service/auth/login"));
...
exports.default = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const { errors, value } = yield (0, login_1.default)(req.body);
        if (errors) {
        ...
        const { status, statusCode, data, message } = yield (0, login_2.default)(value);
