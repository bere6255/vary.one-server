...
const create_1 = __importDefault(require("../../service/order/create"));
...
exports.default = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const { status, statusCode, data, message } = yield (0, create_1.default)({ user, product_id: value.product_id, qty: value.qty });
